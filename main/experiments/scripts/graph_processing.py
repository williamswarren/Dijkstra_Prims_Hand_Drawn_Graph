...
class Graph_Processing():
	...
	def save_graphs(self):
		...
		self.graphviz_original.draw(directory + "/processed-graph.png")
		self.graphviz_weights.draw(directory + "/processed-graph-weights.png")
		self.graphviz_sp.draw(directory + "/processed-graph-sp.png")
		self.graphviz_mst.draw(directory + "/processed-graph-mst.png")
